""" 
    lifted from KoopmanLib library: 
    https://github.com/fnueske/KoopmanLib/blob/main/RFF/RFF.py
...
from gedmd.util import split_by_lag, whitening_transform, filter_ev
